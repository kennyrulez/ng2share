...
export const platforms: Platforms = {
    ...
    googlePlus: {
        ...
        icon:
            'M7,7.7h3.1c-0.5,1.6-2,2.7-3.8,2.6c-2.1,0-3.9-1.7-3.9-3.8c-0.1-2.3,1.7-4.1,4-4.1c1,0,2,0.4,2.7,1c0.2,0.2,0.4,0.2,0.6,0l1.1-1.1c0.2-0.2,0.2-0.5,0-0.6C9.7,0.7,8.2,0,6.5,0C3-0.1,0,2.8,0,6.4c0,3.6,2.8,6.4,6.4,6.4	c3.4,0,6.2-2.7,6.4-6c0,0,0-1.5,0-1.5H7c-0.2,0-0.4,0.2-0.4,0.4v1.6C6.6,7.5,6.8,7.7,7,7.7z',
        text: 'Share'
    },
    facebook: {
        name: 'facebook',
    ...
    tumblr: {
        ...
        icon:
            'M10.5,15.9c0,0-0.6,0.7-1.7,0.7s-1.6-0.7-1.6-1.7c0-0.4,0-2.9,0-5.7h3.6V5.7H7.2c0-3.1,0-5.7,0-5.7H4.4C4,2.6,2.3,4.7,0,5.7v3.4h2.7c0,3.3,0,6.4,0,6.6c0,0.9,0.9,4.2,5.3,4.2c2.6,0,3.6-1.7,3.6-1.7L10.5,15.9z',
        text: 'Share',
        properties: {
            title: 'title',
            caption: 'description'
